...
public class BPlusTreeFloatTest {
    ...
    public void testCreate() throws IOException {
        ...
        try {
            ...
            tree.insert(List.of(4.1f));
            tree.insert(List.of(10.2f));
            tree.insert(List.of(20.3f));
            tree.insert(List.of(304f));
            tree.insert(List.of(15.5f));
            tree.insert(List.of(12.6f));
            tree.insert(List.of(17.7f));
            tree.insert(List.of(6.9f));
            tree.insert(List.of(25.11f));
            tree.insert(List.of(6.12f));
    ...
    public void testDelete() throws IOException {
        ...
        try {
            ...
            List ptr = tree2.find(List.of(65.616f));
            assertTrue((float) ptr.get(0) == 65.616f);

            tree2.printTree();
            tree2.delete(List.of(65.616f));

            assertTrue(tree2.isTreeValid());

            assertNull(tree2.find(List.of(65.616f)));
        } finally {
            tree.close();
            assert tree2 != null;
            tree2.close();
